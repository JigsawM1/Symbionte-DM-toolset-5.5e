          ...
          <div style={estilos.cuerpoDetalle}>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "6px" }}>
                  ...
                  {hechizoSeleccionado.dadosDaño && (
                    <div style={{ fontSize: "11px" }}>
                      ...
                      <strong
                        onClick={() => {
                          const tipoD = (hechizoSeleccionado.tipoDaño && hechizoSeleccionado.tipoDaño !== "N/A")
                            ? hechizoSeleccionado.tipoDaño
                            : detectarTipoDaño(hechizoSeleccionado.descripcion, "Daño");
                          const formulaConEtiqueta = `!${hechizoSeleccionado.nombre} (${tipoD}):${hechizoSeleccionado.dadosDaño}`;
                          lanzarDadosTaleSpire(formulaConEtiqueta, hechizoSeleccionado.nombre);
                        }}
                        style={{ color: "#ff7675", cursor: "pointer", textDecoration: "underline dashed", marginLeft: "2px" }}
                        title="Hacer click para lanzar dados físicos en TaleSpire"
                      >
                        🎲 {hechizoSeleccionado.dadosDaño} {hechizoSeleccionado.tipoDaño && hechizoSeleccionado.tipoDaño !== "N/A" ? `(${hechizoSeleccionado.tipoDaño})` : ""}
                      </strong>
                    </div>
                  )}
                      ...
                      <strong
                        onClick={() => {
                          const tipoD = (hechizoSeleccionado.tipoDaño && hechizoSeleccionado.tipoDaño !== "N/A")
                            ? hechizoSeleccionado.tipoDaño
                            : detectarTipoDaño(hechizoSeleccionado.descripcion, "Daño");
                          const formulaConEtiqueta = `!Niv. Superior (${tipoD}):${hechizoSeleccionado.dadosDañoNivelSuperior}`;
                          lanzarDadosTaleSpire(formulaConEtiqueta, `Nivel Superior: ${hechizoSeleccionado.nombre}`);
                        }}
                        style={{ color: "#74b9ff", cursor: "pointer", textDecoration: "underline dashed", marginLeft: "2px" }}
                        title="Hacer click para lanzar dados físicos en TaleSpire"
                      >
                        🎲 +{hechizoSeleccionado.dadosDañoNivelSuperior}
                      </strong>
            ...
            <div style={estilos.seccionDescripcionFicha}>
              ...
              <div style={estilos.descripcionCuerpoFicha}>
                {renderizarTextoConDadosInteractivos(hechizoSeleccionado.descripcion, hechizoSeleccionado.nombre)}
              </div>
            </div>
            ...
            {hechizoSeleccionado.descNivelSuperior && (
              <div style={estilos.seccionDescripcionFicha}>
                ...
                <div style={{ ...estilos.descripcionCuerpoFicha, color: "var(--color-texto-secundario)" }}>
                  {renderizarTextoConDadosInteractivos(hechizoSeleccionado.descNivelSuperior, "Nivel Superior: " + hechizoSeleccionado.nombre)}
                </div>
              </div>
            )}
