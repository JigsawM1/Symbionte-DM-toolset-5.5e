                  ...
                  <div key={sel.id} className={estilos.tarjetaSelectorModal}>
                    ...
                    <div className={estilos.gridOpcionesSelectorModal}>
                      {sel.opciones.map((op) => {
                        ...
                        const cumpleNivel = op.nivelMinimo === undefined || nivelPersonaje === undefined || nivelPersonaje >= op.nivelMinimo;
                        ...
                        return (
                          ...
                          >
                            ...
                            >
                              <span className={estilos.nombreOpcionSelector} style={{ display: "inline-flex", alignItems: "center", gap: 4 }}>
                                {op.nombre}
