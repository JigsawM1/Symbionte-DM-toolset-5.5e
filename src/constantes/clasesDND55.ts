...
export const CATALOGO_CLASES_DND55: DefinicionClase[] = [
  ...
  },
  {
    ...
    rasgos: [
      ...
      {
        nivel: 1,
        nombre: "Opciones de invocación sobrenatural",
        descripcion: "Las opciones de Invocación sobrenatural aparecen en orden alfabético.\n\n***Armadura de sombras.*** Puedes lanzar *armadura de mago* sobre ti mismo sin gastar un espacio de conjuro.\n\n***Bebedor de vida.*** *Requisito previo:*\nUna vez por turno, cuando aciertes a una criatura con tu arma del pacto, puedes infligir 1d6 de daño necrótico, psíquico o radiante adicional (a tu elección) a la criatura, y puedes gastar uno de tus dados de puntos de golpe para tirarlo y recuperar una cantidad de puntos de golpe igual al resultado más tu modificador por Constitución (mínimo de 1 punto de golpe).\n\n***Castigo sobrenatural.*** *Requisito previo:*\nUna vez por turno, cuando aciertes a una criatura con tu arma del pacto, puedes gastar un espacio de conjuro de Magia del pacto para infligir 1d8 de daño de fuerza adicional al objetivo, más otro 1d8 por cada nivel del espacio de conjuro, y puedes otorgarle al objetivo el estado de derribado si es Enorme o más pequeño.\n\n***Descarga agónica.*** *Requisito previo:*\nElige uno de tus trucos conocidos de brujo que inflija daño. Puedes sumar tu modificador por Carisma a las tiradas de daño de ese conjuro.\n\n***Repetible.*** Puedes obtener esta invocación más de una vez. Cada vez que lo hagas, elige un truco elegible diferente.\n\n***Descarga repelente.*** *Requisito previo:*\nElige uno de tus trucos conocidos de brujo que requiera una tirada de ataque. Cuando aciertes a una criatura Grande o más pequeña con ese truco, puedes empujar a la criatura hasta 3 m (10 pies) en línea recta lejos de ti.\n\n***Repetible.*** Puedes obtener esta invocación más de una vez. Cada vez que lo hagas, elige un truco elegible diferente.\n\n***Don de las profundidades.*** *Requisito previo:*\nPuedes respirar bajo el agua y obtienes una velocidad nadando igual a tu velocidad.\nTambién puedes lanzar *respirar bajo el agua* una vez sin gastar un espacio de conjuro. Recuperas la capacidad de lanzarlo de esta forma cuando finalizas un descanso largo.\n\n***Don de los protectores.*** *Requisito previo:*\nAparece una nueva página en tu Libro de las sombras cuando lo conjuras. Con tu permiso, una criatura puede emplear una acción para escribir su nombre en esa página, que puede contener una cantidad de nombres igual a tu modificador por Carisma (mínimo un nombre).\nCuando cualquier criatura cuyo nombre esté en la página se reduzca a 0 puntos de golpe pero no muera en el acto, la criatura pasa mágicamente a tener 1 punto de golpe en su lugar. Una vez que se activa esta magia, ninguna criatura puede beneficiarse de ella hasta que finalices un descanso largo.\nComo acción de magia, puedes borrar un nombre de la página tocándolo.\n\n***Espada devoradora.*** *Requisito previo:*\nEl Ataque adicional de tu invocación Espada sedienta confiere dos ataques adicionales en lugar de uno.\n\n***Espada sedienta.*** *Requisito previo:*\nObtienes el rasgo Ataque adicional solo para tu arma del pacto. Con ese rasgo, puedes atacar dos veces con el arma en lugar de una cuando lleves a cabo la acción de atacar en tu turno.\n\n***Inversión del amo de la cadena.*** *Requisito previo:*\nCuando lanzas *encontrar familiar*, imbuyes al familiar convocado con una parte de tu poder sobrenatural, otorgándole a la criatura los siguientes beneficios:\n\n***Aéreo o acuático.*** El familiar obtiene una velocidad volando o una velocidad nadando (a tu elección) de 12 m (40 pies).\n\n***Ataque rápido.*** Como acción adicional, puedes ordenarle al familiar que realice la acción de atacar.\n\n***Daño necrótico o radiante.*** Cada vez que el familiar inflija daño contundente, perforante o cortante, puedes hacer que inflija daño necrótico o radiante en su lugar.\n\n***Tu CD de salvación.*** Si el familiar obliga a una criatura a hacer una tirada de salvación, utiliza tu CD de salvación de conjuros.\n\n***Resistencia.*** Cuando el familiar sufra daño, puedes usar una reacción para otorgarle resistencia contra ese daño.\n\n***Lanza sobrenatural.*** *Requisito previo:*\nElige uno de tus trucos conocidos de brujo que inflija daño y tenga un alcance de 3 m (10 pies) o superior. Cuando lances ese conjuro, su alcance aumenta en una cantidad de pies igual a 30 veces tu nivel de brujo (9 metros por nivel).\n\n***Repetible.*** Puedes obtener esta invocación más de una vez. Cada vez que lo hagas, elige un truco elegible diferente.\n\n***Lecciones de los Primeros.*** *Requisito previo:*\nHas recibido conocimiento de una entidad anciana del multiverso, lo que te permite obtener una dote de origen de tu elección.\n\n***Repetible.*** Puedes obtener esta invocación más de una vez. Cada vez que lo hagas, elige una dote de origen diferente.\n\n***Máscara de muchas caras.*** *Requisito previo:*\nPuedes lanzar *disfrazarse* sin gastar un espacio de conjuro.\n\n***Maestro de miríadas de formas.*** *Requisito previo:*\nPuedes lanzar *alterar el propio aspecto* sin gastar un espacio de conjuro.\n\n***Mente sobrenatural.*** Tienes ventaja en las tiradas de salvación de Constitución que hagas para mantener la concentración.\n\n***Mirada de dos mentes.*** *Requisito previo:*\nPuedes usar una acción adicional para tocar a una criatura voluntaria y percibir a través de sus sentidos hasta el final de tu siguiente turno. Mientras la criatura esté en el mismo plano de existencia que tú, puedes usar una acción adicional en turnos posteriores para mantener esta conexión, extendiendo la duración hasta el final de tu siguiente turno. La conexión termina si no la mantienes de esta manera.\nMientras percibas a través de los sentidos de la otra criatura, te beneficias de cualquier sentido especial que posea esa criatura, y puedes lanzar conjuros como si estuvieras en tu espacio o en el espacio de la otra criatura si ambos os encontráis a 18 m (60 pies) o menos el uno del otro.\n\n***Pacto de la cadena.*** Aprendes el conjuro *encontrar familiar* y puedes lanzarlo como acción de magia sin gastar un espacio de conjuro.\nCuando lanzas el conjuro, eliges una de las formas normales para tu familiar o una de las siguientes formas especiales: **diablillo**, **pseudodragón**, **quásit**, **esqueleto**, **renacuajo slaad**, **esfinge de las maravillas**, **duendecillo** o **serpiente venenosa** (consulta el apéndice B para ver el perfil del familiar).\nAdemás, cuando lleves a cabo la acción de atacar, puedes renunciar a uno de tus propios ataques para permitir que tu familiar realice un ataque propio con su reacción.\n\n***Pacto de la espada.*** Como acción adicional, puedes conjurar un arma del pacto en tu mano —un arma cuerpo a cuerpo sencilla o marcial de tu elección con la que te vinculas— o crear un vínculo con un arma mágica que toques; no puedes vincularte con un arma mágica si otra persona está sintonizada con ella o si otro brujo está vinculado a ella. Hasta que termine el vínculo, tienes competencia con el arma y puedes usarla como canalizador mágico.\nCada vez que ataques con el arma vinculada, puedes usar tu modificador por Carisma para las tiradas de ataque y de daño en lugar de usar Fuerza o Destreza; y puedes hacer que el arma inflija daño necrótico, psíquico o radiante, o su tipo de daño habitual.\nTu vínculo con el arma termina si usas de nuevo la acción adicional de este rasgo, si el arma está a más de 1,5 m (5 pies) de ti durante 1 minuto o más, o si mueres. Un arma conjurada desaparece cuando termina el vínculo.\n\n***Pacto del tomo.*** Tejiendo hebras de sombra, conjuras un libro en tu mano al finalizar un descanso corto o largo. Este Libro de las sombras (tú determinas su apariencia) contiene magia sobrenatural a la que solo tú puedes acceder, otorgándote los beneficios a continuación. El libro desaparece si conjuras otro libro con este rasgo o si mueres.\n\n***Trucos y rituales.*** Cuando aparezca el libro, elige tres trucos y dos conjuros de nivel 1 que tengan la etiqueta de ritual. Los conjuros pueden proceder de la lista de conjuros de cualquier clase y deben ser conjuros que no tengas preparados. Mientras lleves el libro encima, tienes preparados los conjuros elegidos y funcionan como conjuros de brujo para ti.\n\n***Canalizador mágico.*** Puedes utilizar el libro como canalizador mágico.\n\n***Paso ascendente.*** *Requisito previo:*\nPuedes lanzar *levitar* sobre ti mismo sin gastar un espacio de conjuro.\n\n***Salto de otro mundo.*** *Requisito previo:*\nPuedes lanzar *salto* sobre ti mismo sin gastar un espacio de conjuro.\n\n***Susurros de la tumba.*** *Requisito previo:*\nPuedes lanzar *hablar con los muertos* sin gastar un espacio de conjuro.\n\n***Uno con las sombras.*** *Requisito previo:*\nMientras estés en un área de luz tenue u oscuridad, puedes lanzar *invisibilidad* sobre ti mismo sin gastar un espacio de conjuro.\n\n***Vigor infernal.*** *Requisito previo:*\nPuedes lanzar *vida falsa* sobre ti mismo sin gastar un espacio de conjuro. Cuando lances el conjuro con este rasgo, no tiras el dado para los puntos de golpe temporales; obtienes automáticamente el número más alto en el dado.\n\n***Visiones brumosas.*** *Requisito previo:*\nPuedes lanzar *imagen silenciosa* sin gastar un espacio de conjuro.\n\n***Visiones de reinos lejanos.*** *Requisito previo:*\nPuedes lanzar *ojo arcano* sin gastar un espacio de conjuro.\n\n***Vista de bruja.*** *Requisito previo:*\nTienes visión verdadera con un alcance de 9 m (30 pies).\n\n***Vista de diablo.*** *Requisito previo:*\nPuedes ver normalmente en luz tenue y en oscuridad —tanto mágica como no mágica— a 36 m (120 pies) o menos de ti.",
        tipoAccion: "accion_adicional",
        tieneUsosLimitados: true,
        recuperacion: "descanso_corto",
        formulaDados: "1d6"
