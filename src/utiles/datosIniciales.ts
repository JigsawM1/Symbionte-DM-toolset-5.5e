...
export const EFECTOS_PREDEFINIDOS: EfectoPredefinido[] = [
  ...
  { nombre: "Afinidad con la piedra", descripcion: "Como acción adicional, ganas la capacidad de sentir vibraciones con un alcance de 60 pies durante 10 minutos (100 asaltos) mientras estés en contacto con una superficie de piedra (natural o labrada).", duracionEstandar: 100 },
  { nombre: "Forma grande", descripcion: "Transformación en tamaño Grande durante 10 minutos (100 asaltos). Tienes ventaja en pruebas de Fuerza, tu velocidad aumenta en 10 pies y tu tamaño pasa a Grande.", duracionEstandar: 100 }
];
